...
const Modal = ({ isOpen, onClose, initialData, onProductAdded }) => {
	...
	const handleImageChange = (e, type) => {
		console.log('Image type:', type); // Log the image type
			...
			<div className='bg-white rounded-lg shadow-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-scroll'>
				...
				<form onSubmit={handleSubmit} encType='multipart/form-data' className='space-y-4'>
					...
					<div>
						...
						<label>
							<input type='checkbox' name='hoodie' checked={productType.hoodie} onChange={handleProductTypeChange} />{' '}
							Hoodie
						</label>
						<label>
							<input type='checkbox' name='shirt' checked={productType.shirt} onChange={handleProductTypeChange} />{' '}
							Shirt
						</label>
						<label>
							<input type='checkbox' name='trouser' checked={productType.trouser} onChange={handleProductTypeChange} />{' '}
							Trouser
						</label>
						<label>
							<input type='checkbox' name='polo' checked={productType.polo} onChange={handleProductTypeChange} /> polo
						</label>
						<label>
							<input type='checkbox' name='pant' checked={productType.pant} onChange={handleProductTypeChange} /> pant
						</label>
						<label>
							<input
								type='checkbox'

...
const AddLogoPopup = ({ onBack, onNext, onUpload }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full mx-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Text Logo Option */}
          <div
            className="text-center p-4 border rounded-lg hover:shadow-md cursor-pointer"
            onClick={onNext} // Transition to AddTextLogoPopup
          >
            ...
            <p className="text-sm text-gray-500">
              Add a basic font to your garments. For example, a company, club,
              or employee name.
            </p>
          </div>
          ...
          <div
            className="text-center p-4 border rounded-lg hover:shadow-md cursor-pointer"
            onClick={onUpload} // Transition to UploadLogoPopup
          >
            <div className="bg-orange-500 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-3">
              <svg
            ...
            <p className="text-sm text-gray-500">
              Your setup will be completely free!
            </p>
          </div>
        </div>

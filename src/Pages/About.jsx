...
const About = () => {
  ...
  return (
    ...
    <div className="container mx-auto my-28 px-4">
      <div className="  flex flex-col-reverse gap-2 sm:flex md:flex-row items-center justify-between">
        <div className=" h-auto w-full  md:w-2/3 mb-8 md:mb-0 px-10">
       
          <h1 className="text-2xl md:text-4xl text-center mt-2 font-bold mb-4 text-gray-900">
            Welcome to <span className='text-[#EB5800]'> Professor Store</span> 
          </h1>
